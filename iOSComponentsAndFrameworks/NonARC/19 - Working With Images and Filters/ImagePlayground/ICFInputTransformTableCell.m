...
- (void)dealloc {
    self.inputTransformLabel = nil;
    self.inputTXTextField = nil;
    self.inputTYTextField = nil;
    self.inputRotateTextField = nil;
    self.inputSXTextField = nil;
    self.inputSYTextField = nil;
    [super dealloc];
}
